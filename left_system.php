...
<body>
<div id="leftT" class="leftT">系統公告</div>
<div id="leftL"><a href="system.php?type=0">綜合</a></div>
<?php 
	for($i=0; $i< $row_num; $i++) 
		echo '<div id="leftL"><a href="system.php?type='.$type_list[$i][type_no].'">'.$type_list[$i][name].'</a></div>'; 
?>
