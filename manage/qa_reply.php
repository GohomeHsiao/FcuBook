...
if($_POST[ans_control]==1){
	...
	$sql = "INSERT INTO ask_ans (ask_no, ans_time, answer) VALUES ($_GET[ask_no], '$answer_time', '$answer')";
	mysql_query($sql, $link);
	...
	$sql = "INSERT INTO remind (title, type, release_time, member_id) VALUES ('管理員已經回覆了您的提問，請至您的信箱收信。', '1', '$answer_time', '$ask_data[asker]')";
	mysql_query($sql, $link);
...
function ansCheck(){	
		...
		if(answer)
		{
			document.reply_form.ans_control.value = 1;
...
<div id="main" class="main">
	...
	<form method="POST" name="reply_form" action="qa_reply.php?ask_no=<?php echo $_GET[ask_no]; ?>">
	...
	<tr>
		<td colspan="2"><textarea rows="9" name="answer" cols="48"></textarea></td>
	</tr>
	<tr>
